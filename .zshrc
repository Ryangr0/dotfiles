...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status command_execution_time load ram battery time)
...
# Uncomment the following line to disable auto-setting wterminal title.
